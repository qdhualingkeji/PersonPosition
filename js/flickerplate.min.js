    ...
    (b.settings = {
      ...
      (b.init = function (f, h) {
        ...
        j && j.length > 0
          ? ((b.settings.theme = j),
            d.addClass(
              k && k.length > 0 ? "flicker-theme-" + k : "flicker-theme-" + j
            ))
          : d.addClass("flicker-theme-" + b.settings.theme);
        var l = d.data("block-text");
        if (
          (void 0 != l && 0 == l && (b.settings.block_text = !1),
          d.find("ul.flicks > li").each(function () {
            e++,
              a(this).wrapInner(
                '<div class="flick-inner"><div class="flick-content"></div></div>'
              ),
              ($flick_block_text = a(this).data("block-text")),
              void 0 != $flick_block_text
                ? 1 == $flick_block_text &&
                  (a(this)
                    .find(".flick-title")
                    .wrapInner('<span class="flick-block-text"></span>'),
                  a(this)
                    .find(".flick-sub-text")
                    .wrapInner('<span class="flick-block-text"></span>'))
                : 1 == b.settings.block_text &&
                  (a(this)
                    .find(".flick-title")
                    .wrapInner('<span class="flick-block-text"></span>'),
                  a(this)
            ...
            c &&
              ...
              $flick_theme &&
                $flick_theme.length > 0 &&
                a(this).addClass("flick-theme-" + $flick_theme);
          }),
          "scroller-slide" != b.settings.flick_animation)
        ) {
          ($data_arrow_navigation = d.data("arrows")),
            void 0 != $data_arrow_navigation
              ? 0 != $data_arrow_navigation && b.create_arrow_navigation()
              : 1 == b.settings.arrows && b.create_arrow_navigation(),
            ($data_dot_navigation = d.data("dot-navigation")),
            ($data_dot_alignment = d.data("dot-alignment"));
          var m = b.settings.dot_alignment;
          void 0 != $data_dot_alignment &&
            ("left" == $data_dot_alignment || "right" == $data_dot_alignment) &&
            (m = $data_dot_alignment),
            void 0 != $data_dot_navigation
              ? 0 != $data_dot_navigation && b.create_dot_navigation(m)
              : 1 == b.settings.dot_navigation && b.create_dot_navigation(m),
            ...
            $data_auto_flick_delay &&
              ($flick_delay = 1e3 * $data_auto_flick_delay),
            void 0 != $data_auto_flick &&
              (b.settings.auto_flick = 0 != $data_auto_flick),
            b.auto_flick_start(),
            b.flick_flicker(),
            "jquery-slide" != b.settings.flick_animation &&
              d
                .find("ul.flicks")
                .bind(
      ...
      (b.create_arrow_navigation = function () {
        ($arrow_nav_html =
          ...
          void 0 != $data_arrows_constraint &&
            (b.settings.arrows_constraint = $data_arrows_constraint),
          d.find(".arrow-navigation").on("click", function () {
            a(this).hasClass("right")
              ? ++c == e && (c = b.settings.arrows_constraint ? e - 1 : 0)
              : --c < 0 && (c = b.settings.arrows_constraint ? 0 : e - 1),
              b.move_flicker(c);
          });
      }),
      (b.create_dot_navigation = function (c) {
        for (
          $dot_nav_html = '<div class="dot-navigation ' + c + '"><ul>';
          e > f;
      ...
      (b.auto_flick_start = function () {
        1 == b.settings.auto_flick &&
          (b.flicker_auto = setInterval(b.auto_flick, $flick_delay));
      }),
      ...
      (b.move_flicker = function (a) {
        ...
        (c = a),
          "transform-slide" == b.settings.flick_animation
            ? d
                .find("ul.flicks")
                .attr({
                  style:
            ...
            : "transition-slide" == b.settings.flick_animation
            ? d.find("ul.flicks").attr({ style: "left:-" + c + "00%;" })
            : "jquery-slide" == b.settings.flick_animation &&
              d
                .find("ul.flicks")
                .animate({ left: "-" + c + "00%" }, function () {
                  g = !1;
                }),
          ...
          d.addClass(
            $crt_flick.hasClass("flick-theme-dark")
              ? "flicker-theme-dark"
              : $crt_flick.hasClass("flick-theme-light")
              ? "flicker-theme-light"
              : "flicker-theme-" + b.settings.theme
          ),
